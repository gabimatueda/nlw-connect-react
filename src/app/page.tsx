  ...
  return (
    <main className="max-w-[1240px] mx-auto px-5 py-8 md:py-0">
      ...
      <div className="flex gap-5 items-stretch flex-col md:flex-row">
        <div className="felex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="font-heading font-semibold text-gray-200 text-xl">Sobre o evento</h2>
            <span className="tex-purple font-semibold text-xs flex items-center gap-2">
